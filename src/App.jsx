...
    details: [
      "Interviewed stakeholders; prioritized explain‑why patterns.",
    ],
  },
];
...
    details: [
      "Scaled communications and reusable toolkits for officers.",
    ],
  },
  {
...
            </a>
          ))}
          <a href="#contact" className="text-sm"><Button size="sm">Resume</Button></a>
        </nav>
...
              <Button onClick={copyEmail}><Mail className="mr-2 h-4 w-4" />{copied ? "Copied" : "Email"}</Button>
              <a href={ABOUT.contacts.linkedin} target="_blank" rel="noreferrer"><Button variant="outline"><Linkedin className="mr-2 h-4 w-4" />LinkedIn</Button></a>
              <a href={ABOUT.contacts.resume}><Button variant="ghost"><FileText className="mr-2 h-4 w-4" />Resume</Button></a>
            </div>
          </div>
          <div>
            <Card className="shadow-xl bg-white/80 backdrop-blur border-black/10">
              <CardHeader>
                <CardTitle className="flex items-center gap-2"><Cpu className="h-5 w-5" /> Live Snapshot</CardTitle>
              </CardHeader>
              <CardContent>
...
          <AwardsList />
        ) : (
          dataset.map((item, idx) => <WorkCard key={idx} item={item} />)
        )}
      </div>
    </Section>
  );
...
              <span><strong>Org:</strong> {a.org}</span>
              <span><strong>Level:</strong> {a.level}</span>
              <span><strong>Rank:</strong> {a.rank}</span>
...
              <CardTitle className="text-base flex items-center gap-2"><GraduationCap className="h-4 w-4"/>Highlights</CardTitle>
              <div className="hidden md:flex items-center gap-2">
                {tabs.map((t,i)=> (
                  <Chip key={t} active={i===active} onClick={()=>setActive(i)}>{t}</Chip>
                ))}
              </div>
            </div>
          </CardHeader>
...
                  <li key={bi} className="flex items-start gap-2"><ChevronRight className="h-4 w-4 mt-0.5 opacity-60" /><span>{b}</span></li>
                ))}
              </ul>
            </div>
          </CardContent>
...
      ].map((t, i) => (
        <Card key={i} className="bg-white/80 backdrop-blur border-black/10"><CardContent className="text-sm">{t}</CardContent></Card>
      ))}
    </div>
  </Section>
);
...
          <p className="opacity-80 mt-1">LinkedIn: <a className="underline" href={ABOUT.contacts.linkedin}>Profile</a></p>
        </CardContent>
      </Card>
      <Card className="bg-white/80 backdrop-blur border-black/10">
        <CardHeader>
...
          <div className="mt-3">
            <Button asChild><a href={ABOUT.contacts.resume}><FileText className="h-4 w-4 mr-2"/>Download</a></Button>
          </div>
        </CardContent>
      </Card>
      <Card className="bg-white/80 backdrop-blur border-black/10">
...
        <CardContent className="text-sm">
          <ul className="space-y-2">
            <li className="flex items-center gap-2"><LinkIcon className="h-4 w-4"/> <a className="underline" href="#work">Portfolio</a></li>
            <li className="flex items-center gap-2"><Users2 className="h-4 w-4"/> <a className="underline" href="#community">Community impact</a></li>
            <li className="flex items-center gap-2"><Star className="h-4 w-4"/> <a className="underline" href="#fun">Fun facts</a></li>
            <li className="flex items-center gap-2"><Users2 className="h-4 w-4"/> <a className="underline" href="#story">Leadership story</a></li>
          </ul>
        </CardContent>
      </Card>
    </div>
...
                  {ABOUT.highlights.map((h, i) => (
                    <li key={i} className="flex items-start gap-2"><ChevronRight className="h-4 w-4 mt-0.5"/> <span>{h}</span></li>
                  ))}
                </ul>
              </CardContent>
            </Card>

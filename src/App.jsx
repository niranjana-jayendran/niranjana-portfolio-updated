...
const AWARDS = [
  {
    title: "NSDA Extemporaneous Speaking — National Qualifier (1st)",
    org: "NSDA",
    level: "National",
    year: 2025,
    rank: "1st",
    notes: "Qualified via district championship",
  },
  {
    title: "District Champion — Extemporaneous Speaking",
    org: "NSDA",
    level: "District",
    year: 2024,
    rank: "1st",
    notes: "Team historian; led chapter engagement +25%",
  },
  {
    title: "District Finalist — Extemporaneous Speaking",
    org: "NSDA",
    level: "District",
    year: 2023,
    rank: "2nd",
    notes: "Multiple placements across seasons",
  },
  {
    title: "BPA SLC — Economic Research",
    org: "BPA Florida",
    level: "State",
    year: 2024,
    rank: "2nd",
    notes: "Team project; 150+ teams statewide",
  },
  {
    title: "BPA SLC — Presentation Team",
    org: "BPA Florida",
    level: "State",
    year: 2024,
    rank: "3rd",
    notes: "Cross‑functional presentation event",
  },
  {
    title: "DECA Districts — Travel & Tourism TDM",
    org: "DECA",
    level: "District",
    year: 2025,
    rank: "2nd",
    notes: "Advanced to Florida States in chapter’s founding year",
  },
  {
    title: "DECA States — Travel & Tourism TDM",
    org: "DECA",
    level: "State",
    year: 2025,
    rank: "1st",
    notes: "Advanced to ICDC",
  },
  {
    title: "PSAT/NMSQT — National Merit Scholar",
    org: "College Board",
    level: "National",
    year: 2025,
    rank: "Top 1%",
    notes: "National Merit Scholar",
  },
  {
    title: "RCM Piano — First Class Honors",
    org: "Royal Conservatory of Music",
    level: "National",
    year: 2023,
    rank: "Honors",
    notes: "Multiple First Class Honors; Silver/Bronze medals",
  },
  {
    title: "World Culture Festival Performer",
    org: "Art of Living Foundation",
    level: "International",
    year: 2023,
    rank: "Selected Performer",
    notes: "Performed Bharatanatyam on the National Mall (1M+ audience)",
  },
  {
  ...
  return (
    ...
    >
      ...
      <div className="grid md:grid-cols-2 gap-6">
        {activeTab === "awards" ? <AwardsList /> : dataset.map((item, idx) => <WorkCard key={idx} item={item} />)}
      </div>
    </Section>
  );
};
  ...
  return (
    <div className="md:col-span-2">
      ...
      <p className="text-xs opacity-60 mt-2">
        Missing or off by a line? Paste the exact awards block from your résumé and I’ll slot
        them in verbatim.
      </p>
    </div>
  );
    ...
    <div className="grid md:grid-cols-2 gap-6">
      <WorkCard
        item={{
          ...
          summary:
            "Keynoted to 1,000+ educators at NSBA; led student & staff sessions with practical take‑home guides.",
          details: [
      ...
      <WorkCard
        item={{
          ...
          summary:
            "Multi‑week officer training adopted across chapters; improved meeting quality and event readiness.",
          details: [
            "Templates, agendas, and role guides reusable statewide.",
            "Increased officer confidence and chapter self‑sufficiency.",
          ],
        }}
      />
      <WorkCard
        item={{
          ...
          summary:
            "Cross‑state mentorship network to raise participation and retention; storytelling pitch centered on durable peer ties.",
      ...
      <WorkCard
        item={{
          ...
          summary:
            "Hands‑on STEM workshops for elementary students; confidence‑building through making.",
      ...
      <WorkCard
        item={{
          ...
          org: "Pine View School",
          summary:
            "Organized school‑wide competition; raised $1,000+ for student ventures.",
          ...
          <CardHeader>
            <div className="flex items-center justify-between gap-2">
              <CardTitle className="text-base flex items-center gap-2">
                <GraduationCap className="h-4 w-4" /> Highlights
              </CardTitle>
